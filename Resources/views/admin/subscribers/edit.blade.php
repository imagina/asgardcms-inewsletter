...
@section('content-header')
    <h1>
        {{ trans('inewsletter::subscribers.title.edit subscribers') }}
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">{{ trans('inewsletter::subscribers.title.edit subscribers') }}</li>
    </ol>
@stop

@section('content')
    {!! Form::open(['route' => ['admin.inewsletter.subscribers.update', $subscribers->id], 'method' => 'put']) !!}
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="tab-content">
                    ...
                    @foreach (LaravelLocalization::getSupportedLocales() as $locale => $language)
                        ...
                        <div class="tab-pane {{ locale() == $locale ? 'active' : '' }}" id="tab_{{ $i }}">
                            @include('inewsletter::admin.subscribers.partials.edit-fields', ['lang' => $locale])
                        </div>
                    @endforeach
